...
$(function () {
  ...
  $(document).on("pageInit", "#page-modal", function(e, id, page) {
    ...
    $content.on('click','.prompt-ok', function () {
      $.prompt('添加房型', function (value) {
          $.alert('成功添加房型！名称是"' + value + '"');
  ...
  $(document).on("pageInit", "#page-picker", function(e, id, page) {
    ...
    $("#picker").picker({
      ...
      cols: [
        {
          textAlign: 'center',
          values: ['101（大户型）', '102（大户型）', '103（大户型）', '104（大户型）', 'iPhone 6', 'iPhone 6 Plus', 'iPad 2', 'iPad Retina', 'iPad Air', 'iPad mini', 'iPad mini 2', 'iPad mini 3'],
