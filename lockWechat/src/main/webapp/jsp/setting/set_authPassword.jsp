    ...
    <div class="page page-current">
        ...
        <div class="content">
                        ...
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <input type="text" placeholder="如果未设置请不要填写"/>
                                </div>
                            </div>
                        </div>
                    </li>
            ...
            <div class="content-block">
                <a href="javascript:void(0);" onclick="setAuthPassword()" class="button button-big button-fill button-success">确认修改</a>
            </div>
        </div>
    </div>
</div>
...
<script type='text/javascript' src='resources/js/set_authPassword.js?ver=6' charset='utf-8'></script>
</body>
</html>