...
<head>
    <title>模块状态</title>
    <link rel="stylesheet" type="text/css" href="../src/main/webapp/resources/styles/component/table.css" />
    <script type="text/javascript" src="../src/main/webapp/resources/easyui/jquery.min.js"></script>
    <script type="text/javascript" src="../src/main/webapp/resources/scripts/component/table.js"></script>
    <script type="text/javascript" src="moduleStatus.js"></script>
</head>
<body>
