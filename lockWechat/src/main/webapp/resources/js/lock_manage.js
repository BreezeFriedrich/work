    ...
    $.ajax({
        ...
        success:function(data,status,xhr){
            ...
            for(x in data){
                ...
                ul_authInfo +=        "<div class='item-after'>"+data[x].formatTimetillminString(startTime)+"</div>";
                ul_authInfo +=    "</div>";
                ul_authInfo += "</li>";
                ul_authInfo += "<li class='item-content'>";
                ul_authInfo +=    "<div class='item-inner'>";
                ul_authInfo +=        "<div class='item-title'>授权结束时间</div>";
                ul_authInfo +=        "<div class='item-after'>"+data[x].formatTimetillminString(endTime)+"</div>";
                ul_authInfo +=    "</div>";
                ul_authInfo += "</li>";
                ul_authInfo += "</ul>";
                ul_authInfo += "</div>";
    ...
    $.ajax({
        ...
        success:function(data,status,xhr){
            ...
            for(x in pwdList){
                ...
                ul_authInfo +=    "<div class='item-inner'>";
                ul_authInfo +=        "<div class='item-title'>授权起始时间</div>";
                ul_authInfo +=        "<div class='item-after'>"+pwdList[x].formatTimetillminString(startTime)+"</div>";
                ul_authInfo +=    "</div>";
                ul_authInfo += "</li>";
                ul_authInfo += "<li class='item-content'>";
                ul_authInfo +=    "<div class='item-inner'>";
                ul_authInfo +=        "<div class='item-title'>授权结束时间</div>";
                ul_authInfo +=        "<div class='item-after'>"+pwdList[x].formatTimetillminString(endTime)+"</div>";
                ul_authInfo +=    "</div>";
                ul_authInfo += "</li>";
                ul_authInfo += "</ul>";
                ul_authInfo += "</div>";
