...
<head>
    ...
    <link rel="stylesheet" href="../src/main/webapp/resources/bootstrap-3.3.0/css/bootstrap.min.css"/>
    ...
    <script type="text/javascript" src="swiperecord_show.js?ver=13"></script>
</head>
<body>
