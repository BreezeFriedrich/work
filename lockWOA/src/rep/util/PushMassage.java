...
public class PushMassage
{
    ...
    public static String pushTextMess(String to, String from, String content)
    {
        ...
        strBuf.append("<xml><ToUserName><![CDATA[");
        strBuf.append(to);
        strBuf.append("]]></ToUserName><FromUserName><![CDATA[");
        strBuf.append(from);
        strBuf.append("]]></FromUserName><CreateTime>");
        strBuf.append(System.currentTimeMillis() / 1000);
        strBuf.append("</CreateTime><MsgType><![CDATA[text]]></MsgType><Content><![CDATA[");
        strBuf.append(content);
        strBuf.append("]]></Content></xml>");
