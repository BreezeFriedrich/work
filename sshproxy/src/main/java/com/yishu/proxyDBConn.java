 ...
 */
public class proxyDBConn {

    private static final org.slf4j.Logger logger= LoggerFactory.getLogger(proxyDBConn.class);
    ...
    public static void go() {
        ...
        try {
            ...
            logger.info("assinged_port:"+Integer.toString(assinged_port));
