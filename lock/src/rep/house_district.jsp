        ...
        <script>
            ...
            $(".fixed-table-box").addRow(function (){
                ...
                for(var i in landlords){
                    ...
                    if(0===locks.length){
                        html += '<tr>';
                        html += '<td  class="table-width2" data-fixed="true"><div class="table-time table-cell table-width2 table-butstyle">当前日期：2017-11-09</div></td>';
...
//                        html += '<td  class="table-width140"><div class="cd table-hight1 table-width140">被预订</div></td>';
                        ...
                        /*
                        html += '<tr>';
                        html +=     '<td rowspan="2"><div class="table-hight2 table-width105 table-butstyle">业主3 NG0325</div></td>';
                        html +=     '<td ><div class="table-hight1 table-width105 table-butstyle">NG032-01</div></td>';
                        html += '</tr>';
                        html += '<tr>';
                        html +=     '<td ><div class="table-hight1 table-width105 table-butstyle">NG032-02</div></td>';
                        html += '</tr>';
                        */
...
<script type="text/javascript">
    ...
    */
    function setLeftColumn() {
        console.log($(".fixed-table-box"));
//        $(".fixed-table-box").fixedTable();
        var aimDom=$('.fixed-table_fixed-left .fixed-table_body tbody');
//        aimDom.empty();
        $(".fixed-table-box").emptyTable();
        $(".fixed-table-box").addRow(function (){
            landlords=userHierarchy.subordinateList;
