...
<body>
	...
	<div class="page-group">
        ...
        <div class="page page-current">
            ...
            <header class="bar bar-nav">
                ...
                <!--javascript:window.location.href='gateway_property.jsp?gatewayCode=888888';-->
                <a class="icon icon-edit pull-right" href="javascript:void(0);" onclick="javascript:window.location.href='gateway_property.jsp?ownerPhoneNumber='+ownerPhoneNumber+'&specificGatewayCode='+specificGatewayCode;"></a>
            </header>
  ...
  <script type='text/javascript' src='js/gateway_manage.js' charset='utf-8'></script>
