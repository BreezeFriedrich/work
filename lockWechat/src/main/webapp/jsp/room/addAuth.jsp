    ...
    <div class="page page-current" id="page-picker">
        ...
        <div class="content native-scroll" style="">
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <input type="text" placeholder="" id="datetime-picker-lk" >
                                </div>
                            </div>
                        </div>
                    </li>
            ...
            <div class="content-block">
                <div class="row">
                    <div class="col-100"><a onclick="doAuth();" class="button button-big button-fill button-success">确认</a></div>
                </div>
            </div>
...
<script type="text/javascript" src="resources/js/room/room_add.js?v=1"></script>
<script>
    var _hmt = _hmt || [];
    (function() {
