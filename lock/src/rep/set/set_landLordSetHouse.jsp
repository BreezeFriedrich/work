            ...
            <div class="block-flat table0-top gateway-table">
                <div class="content">
                    <table>
                        <thead>
                        <tr>
                            <th style="width:10%;"  valign="middle">网关2</th>
                            <td>
                                <button type="button" class="btn btn-primary">门锁9</button>
                                <button type="button" class="btn btn-default">门锁9</button>
                                <button type="button" class="btn btn-default">门锁9</button>
                                <button type="button" class="btn btn-default">门锁9</button>
                                <button type="button" class="btn btn-default">门锁9</button>
                                <button type="button" class="btn btn-default">门锁9</button>
