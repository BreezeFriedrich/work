...
<head>
    ...
    <script type="text/javascript" src="resources/js/room/swiper-3.3.1.min.js"></script>
</head>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <table id="now3" class="tables">
                            <tr class="">
                                <td class="list"><em>12</em><em>中秋</em></td>
                            </tr>
                        </table>
                    </div>
                </div>
            </div>
            <input type="button" class="button-queren" onclick="ychooseDate();" value="确定">
        </section>
        <!-- end calendar -->
    </section>
    <!-- end content -->
...
<script type="text/javascript">
    ...
    function ychooseDate() {
        var day=document.getElementById("top_shu").innerHTML;
        var ym=document.getElementById("ymym").innerHTML;
        var year=ym.substring(0,4);
        var month=ym.substring(5,6);
        var cDate=new Date();
        cDate.setFullYear( parseInt(year),(parseInt(month)-1), parseInt(day) );
        $.ajax({
            type:"POST",
