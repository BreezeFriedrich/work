    ...
    <div class="page page-current">
        ...
        <div class="content">
            ...
            <div class="content-block">
                <a href="javascript:void(0);" onclick="modifyNickname()" class="button button-big button-fill button-success">确认修改</a>
            </div>
        </div>
    </div>
</div>
...
<script type='text/javascript' src='resources/js/set_modifyNickname.js?ver=2' charset='utf-8'></script>
</body>
</html>