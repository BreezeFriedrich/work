package com.hysm.util.wx.demo;

import java.util.Map;
import java.util.SortedMap;
import java.util.TreeMap;

import com.hysm.util.wx.utils.GetWxOrderno;
import com.hysm.util.wx.utils.RequestHandler;
import com.hysm.util.wx.utils.Sha1Util;
import com.hysm.util.wx.utils.TenpayUtil;
...
public class Demo {
	...
	private static String appid = "wxbedd9f6ba44c9ec5";
	private static String appsecret = "2ebc7c9945bb4eef16b0886837e14de8";
	private static String partner = "1219554501";
	// 这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "813eec86368d923c0077b6ca4db2bddb";
	// openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "";
	// 微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.dofei.net/ecdemo/pay/WXnotify.do"; // Key
	 ...
	 * @return
	 */
	public static Map regs_pay(String mch_id, String nonce_str,
			String out_trade_no) {
		RequestHandler reqHandler = new RequestHandler(null, null);
		reqHandler.init(appid, appsecret, partnerkey);
		SortedMap<String, String> packageParams = new TreeMap<String, String>();
	 ...
	 * @return
	 */
	public static Map regs_refun(String mch_id, String nonce_str,
			String out_trade_no) {
		RequestHandler reqHandler = new RequestHandler(null, null);
		reqHandler.init(appid, appsecret, partnerkey);
		SortedMap<String, String> packageParams = new TreeMap<String, String>();
	...
	public static Map wechatRefund(String out_refund_no, String out_trade_no,
			String total_fee, String refund_fee, String nonce_str) {
