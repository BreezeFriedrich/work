...
if($.fn.datagrid && $.fn.datagrid.defaults && $.fn.datagrid.defaults.operators.nofilter ){
	...
	$.fn.datagrid.defaults.operators.equal.text = "=";
	...
	$.fn.datagrid.defaults.operators.less.text = "<";
	$.fn.datagrid.defaults.operators.lessorequal.text = "<=";
	$.fn.datagrid.defaults.operators.greater.text = ">";
	$.fn.datagrid.defaults.operators.greaterorequal.text = ">=";
}